...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Combined Calendar and TimeSlot components working together for complete appointment booking experience.',
      },
    },
  },
  tags: ['autodocs'],
...
export const CompleteBookingFlow: Story = {
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', maxWidth: '800px' }}>
        <div>
          <h3 style={{ marginTop: 0, marginBottom: '1rem', color: '#1a1a1a' }}>Select Date</h3>
          <Calendar
        ...
        {selectedDate && getOpeningHourForDate(selectedDate) && (
          <div>
            <h3 style={{ marginTop: 0, marginBottom: '1rem', color: '#1a1a1a' }}>Select Time</h3>
            <TimeSlotList
              selectedDate={selectedDate}
        ...
        {selectedDate && selectedTime && (
          <div style={{ gridColumn: '1 / -1', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px', border: '1px solid #e9ecef' }}>
            <h4 style={{ margin: '0 0 0.5rem', color: '#1a1a1a' }}>Booking Summary</h4>
...
export const WeekendOnlyHours: Story = {
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', maxWidth: '800px' }}>
        <div>
          <h3 style={{ marginTop: 0, marginBottom: '1rem', color: '#1a1a1a' }}>Select Date (Weekends Only)</h3>
          <Calendar
